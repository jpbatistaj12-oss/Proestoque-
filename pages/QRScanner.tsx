...
import { QrCode, Camera, Search, AlertCircle, X, RotateCcw } from 'lucide-react';
  ...
  return (
    <div className="max-w-md mx-auto space-y-6 pt-2 pb-10 animate-fadeIn px-2">
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-slate-900">
            <div className="text-center space-y-4 px-10">
              ...
              <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest leading-relaxed">
                Permissão de câmera necessária<br/>ou dispositivo sem câmera.
              </p>
              <button 
                onClick={startCamera}
      ...
      <div className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 space-y-4">
        <p className="text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">Problemas com a câmera?</p>
        <div className="flex gap-2">
          <input 
            type="text" 
            placeholder="Digite o ID (ex: CHP-1234)" 
